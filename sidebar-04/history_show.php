...
require('connect.php');
  ...
  $sql = "SELECT * FROM licenseplate WHERE idnumber= $idnumber";
           ...
           <section class="content">
               <div class="container-fluid">
                   <div class="col-sm-12">
                       <div class="card">
                           <div class="card-body">
                           <form action="history_show.php" method="post">
                                    ...
                                    <div class="col-sm-6">
                                          <div class="form-group">
                                              <label>เวลารับ : </label>
                                              <input class="form-control" type="text" name="workin"id="workin"value="<?php echo $row["workin"]  ?>">
                                          </div>
                                      </div>
                                    <div class="col-sm-6">
                                          <div class="form-group">
                                              <label>เวลาออก : </label>
                                              <input class="form-control" type="text" name="workout" id="workout"value="<?php echo $row["workout"]  ?>">
                                          </div>
                                    </div>
                                    </div>
                                </div>
