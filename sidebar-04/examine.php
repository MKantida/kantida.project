            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8"><h2>ตรวจสอบรายชื่อ</h2></div>
                            <div class="col-sm-4">
...
while($row = mysqli_fetch_array($result)) { 
  ...
  <a href='examine_show.php?idnumber=$row[0]'><i style='font-size:20px; color:#2646FB' class='material-icons'>&#xE417;</i></a>
  <a href='edit.php?idnumber=$row[0]'><i style='font-size:20px; color:#FCBC28' class='material-icons'>&#xE254;</i></a>
  <a href='delete_file_db.php?idnumber=$row[0]'><i style='font-size:20px; color:#FC4B28' class='material-icons'>&#xE872;</i></a>
  </td> ";
